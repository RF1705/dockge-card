...
<img width="430" height="170" alt="image" src="https://github.com/user-attachments/assets/1e34180d-e8b7-4785-a0a5-6376559de12e" />
...
- **Native update support** — uses Home Assistant `update.install` entities when available
